...
var ModalTest2 = function (_Component) {
  ...
  function ModalTest2(props) {
    ...
    _this.atoms = function (t) {
      if (t.type === 'input') return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
          'label',
          { style: { margin: '0% 100% 0% 2%' } },
          ' ',
          t.name,
          ' '
        ),
        _react2.default.createElement(Inputtext, {
          ...
          draggable: true,
          key: t.name })
      );else if (t.type === 'botton') return _react2.default.createElement(
        Botton,
        {
          onDragStart: function onDragStart(e) {
            return _this.onDragStart(e, t.name);
        ...
        try {
          for (var _iterator = t.options[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var i = _step.value;
...
ModalTest2.defaultProps = {
  message: 'World',
  tasks: [{ name: " First Name", category: "wip", bgcolor: "yellow", type: "input" }, { name: "Last Name", category: "wip", bgcolor: "pink", type: "input" }, { name: "email", category: "wip", bgcolor: "skyblue", type: "input" }, { name: "botton", category: "wip", bgcolor: "skyblue", type: "botton" }]
};
